    ...
    <div className="min-h-screen bg-[#050505] flex">
      ...
      <aside className="w-64 border-r border-white/10 bg-[#0a0a0a] flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 py-6 px-4 space-y-2">
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors ${activeTab === 'families' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'text-gray-400 hover:text-white hover:bg-white/5 border border-transparent'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors ${activeTab === 'payouts' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'text-gray-400 hover:text-white hover:bg-white/5 border border-transparent'}`}
          >
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="h-20 border-b border-white/10 flex items-center justify-between px-8 bg-[#0a0a0a]/50 backdrop-blur-md sticky top-0 z-10">
          <h1 className="text-xl font-bold text-white capitalize">{activeTab === 'dashboard' ? 'CSR Partner Portal' : activeTab}</h1>
        ...
        <div className="p-4 md:p-8">
              ...
              <div className="bg-[#111] border border-white/10 rounded-2xl overflow-hidden">
                <table className="w-full text-left text-sm text-gray-400">
                  ...
                  <tbody className="divide-y divide-white/5">
                    <tr className="hover:bg-white/5 transition-colors cursor-pointer" onClick={() => setActiveTab('payouts')}>
          ...
          {activeTab === 'families' && (
            <div className="bg-[#111] border border-white/10 rounded-2xl p-8 text-center text-gray-500">
              ...
              <p>A list of all families utilizing your partner code will appear here.</p>
            </div>
          )}
          ...
          {activeTab === 'payouts' && (
            <div className="bg-[#111] border border-white/10 rounded-2xl p-8 text-center text-gray-500">
              ...
              <p>Detailed payout history and downloadable tax receipts will appear here.</p>
            </div>
          )}
        </div>
      </main>
